let taxcalculator = function() {
    ...
    // 2021 & Splitting 
        ...
        if ((income.value/2) <= 9744) {
            ...
            incomeTax.innerHTML = ((995.21*((income.value-9744)/10000)+1400)*(((income.value/2)-9744)/10000)).toFixed(2) + " € pro Person"
        } else if (14754 <= (income.value/2) && (income.value/2) <= 57918) {
            incomeTax.innerHTML = (((208.85*(((income.value/2)-14753)/10000)+2397)*(((income.value/2)-9744)/10000))+950.96).toFixed(2) + " € pro Person"
        } else if (57919 <= (income.value/2) && (income.value/2) <= 274612) {
            incomeTax.innerHTML = ((0.42*(income.value/2))-9136.63).toFixed(2) + " € pro Person"
        } else if (income.value >= 274613) {
            incomeTax.innerHTML = ((0.45*(income.value/2))-17374.99).toFixed(2) + " € pro Person"
        }   
    ...
    // 2020 & Splitting 
        ...
        if ((income.value/2) <= 9408) {
            ...
            incomeTax.innerHTML = ((972.87*((income.value-9408)/10000)+1400)*(((income.value/2)-9408)/10000)).toFixed(2) + " € pro Person"
        } else if (14533 <= (income.value/2) && (income.value/2) <= 57051) {
            incomeTax.innerHTML = (((212.02*(((income.value/2)-14532)/10000)+2397)*(((income.value/2)-14532)/10000))+972.79).toFixed(2) + " € pro Person"
        } else if (57052 <= (income.value/2) && (income.value/2) <= 270500) {
            incomeTax.innerHTML = ((0.42*(income.value/2))-8963.74).toFixed(2) + " € pro Person"
        } else if (income.value >= 270501) {
            incomeTax.innerHTML = ((0.45*(income.value/2))-17078.74).toFixed(2) + " € pro Person"
        }   
        anualIncome.innerHTML = (income.value/2) +" € pro Person"
        taxyear.innerHTML = "2020" 
    // 2019 & Single 
    ...
    // 2019 & Splitting 
        ...
        if ((income.value/2) <= 9168) {
            ...
            incomeTax.innerHTML = ((980.14*((income.value-9168)/10000)+1400)*(((income.value/2)-9168)/10000)).toFixed(2) + " € pro Person"
        } else if (14255 <= (income.value/2) && (income.value/2) <= 55960) {
            incomeTax.innerHTML = (((216.16*(((income.value/2)-14254)/10000)+2397)*(((income.value/2)-14254)/10000))+965.58).toFixed(2) + " € pro Person"
        } else if (55961 <= (income.value/2) && (income.value/2) <= 265326) {
            incomeTax.innerHTML = ((0.42*(income.value/2))-8780.90).toFixed(2) + " € pro Person"
        } else if (income.value >= 265327) {
            incomeTax.innerHTML = ((0.45*(income.value/2))-16740.68).toFixed(2) + " € pro Person"
        }
        anualIncome.innerHTML = (income.value/2) +" € pro Person"
        taxyear.innerHTML = "2019"
    // Default Output 
